...
public class Solved_Tickets extends AppCompatActivity {
    ...
    String HttpURL = "http://192.168.1.54/Ticketing_Tool/solved_tickets.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_solved__tickets);
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(Solved_Tickets.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new ParseJSonDataClass(Solved_Tickets.this).execute();
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
...

        {
            ...
            total_tickets_adapter = new Total_Tickets_Adapter(Solved_Tickets.this, R.layout.ticket_layout, TicketsList);
