...
public class Scheduled_single_record extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scheduled_single_record);
        ...
        if(Text.equals("hr"))
        {
            text1.setText("HR Dashboard - Interviews - Scheduled List - Details("+Name+")");
        }
        else  if(Text.equals("admin"))
        {
            text1.setText("Admin Dashboard - Interviews Dashboard - Scheduled List - Details("+Name+")");
        }
        ...
        admin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Scheduled_single_record.this,HrDashboard.class);
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Scheduled_single_record.this,Interviews_dashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        list.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Scheduled_single_record.this,Add_scheduled.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        admin1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Scheduled_single_record.this,AdminDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Scheduled_single_record.this, Update_scheduled.class);
    ...
    public void Update() {
        ...
        new Scheduled_single_record.Update(this, 0).execute(Name, Qualification, Email, Phone, Status1);
    }
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(Scheduled_single_record.this, QueryForm.class);
                i.putExtra("empid", EMPID);
                ...
                Toast.makeText(Scheduled_single_record.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
