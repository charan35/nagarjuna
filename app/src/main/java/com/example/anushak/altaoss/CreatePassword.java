...
public class CreatePassword extends AppCompatActivity {
    ...
    EditText c_password;
    Button submit;
    String empid1,password1,c_password1,OFFICIALEMAIL,MANAGERMAIL,MANAGERID,HRMAIL,HRID,EMPID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text = (TextView)findViewById(R.id.Grid1);
        empID = (TextView)findViewById(R.id.password_id);

        empid = getIntent().getStringExtra("empid");
        empID.setText(empid);
        text.setText("Change Password ("+empid+")");
    ...
    public void Update(View v)
    {
        ...
        new Update(this,0).execute(empid1,password1);
...

    {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                String password1 = (String) arg0[1];


                String link = "http://altaitsolutions.com/Altadatabase/createpassword.php";
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(CreatePassword.this, QueryForm.class);
                ...
                Toast.makeText(CreatePassword.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
