...
public class Reimbusrment1 extends AppCompatActivity {

    TextView empid,category,date,status,mobile,amount;
    String Empid,Category,Date,Status,Mobile,Amount,PdfUrl,Text,Text1,OFFICIALEMAIL,MANAGERMAIL,MANAGERID,HRMAIL,HRID,EMPID;
    ImageView pdfurl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reimbusrment1);
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Reimbusrment1.this,HrDashboard.class);
        ...
        reimbursement.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Reimbusrment1.this,ReimbursementDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Reimbusrment1.this,Mobile.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        dashboard1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Reimbusrment1.this,AdminDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        if(Text.equals("hr"))
        {
            text1.setText("HR Dashboard - Reimbursement Dashboard - Mobile List - Permission");
        }
        else if(Text.equals("admin"))
        {
            text1.setText("Admin Dashboard - Reimbursement Dashboard - Mobile List - Permission");
        }
        ...
        approve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Update(Reimbusrment1.this,0).execute(Empid, Category, Date, Status, Mobile,Amount);
            }
        });
  ...
  class Update extends AsyncTask<String, Void, String>
  {
      ...
      protected String doInBackground(String... arg0) {
          ...
          try {
              ...
              String mobile = (String) arg0[4];
              String amount = (String) arg0[5];

              String link = "http://altaitsolutions.com/Altadatabase/reimbursementupdate.php";
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(Reimbusrment1.this, QueryForm.class);
                ...
                Toast.makeText(Reimbusrment1.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
