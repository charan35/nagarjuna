...
public class Rejected_candidates extends AppCompatActivity {
    ...
    String HttpURL = "http://altaitsolutions.com/Altadatabase/Rejectedcandidates_list.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rejected_candidates);
        ...
        if(Text.equals("hr"))
        {
            text1.setText("HR Dashboard - Interviews Dashboard - History - Rejected Candidates List");
        }
        else  if(Text.equals("admin"))
        {
            text1.setText("Admin Dashboard - Interviews Dashboard - History - Rejected Candidates List");
        }
        ...
        interview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rejected_candidates.this,Interviews_dashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        history.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Rejected_candidates.this,Interview_history.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Rejected_candidates.this, ListViewClickData.getProName(), Toast.LENGTH_SHORT).show();

                BackGroundempdir b = new BackGroundempdir();
                b.execute(ListViewClickData.getProName());
    ...
    private class ParseJSonDataClass2 extends AsyncTask<Void, Void, Void> {
        ...
        {
            interviewAdapter = new Interview_Adapter(Rejected_candidates.this, R.layout.update_list, interviewUpdatesList);
    ...
    class BackGroundempdir extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
           ...
           /* Intent i = new Intent(com.example.nagarjuna.com.interviews.Rejected_candidates.this,Show_single_record.class);
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Toast.makeText(Rejected_candidates.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
