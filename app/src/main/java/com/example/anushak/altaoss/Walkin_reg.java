...
public class Walkin_reg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_walkin_reg);
        ...
        interviewtype =(TextView)findViewById(R.id.walkin);
        ...
        if (Text.equals("hr")) {
            text1.setText("HR Dashboard - Interviews Dashboard - Walkin Candidates list - New Registration");
        } else if (Text.equals("admin")) {
            text1.setText("Admin Dashboard - Interviews Dashboard - Walkin Candidates list - New Registration");
        }
        ...
        admin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Walkin_reg.this, HrDashboard.class);
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Walkin_reg.this, Interviews_dashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        form.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Walkin_reg.this, Add_walkin.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        admin1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Walkin_reg.this, AdminDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(Walkin_reg.this, QueryForm.class);
                ...
                Toast.makeText(Walkin_reg.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
