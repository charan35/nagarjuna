...
public class not_confirmed_candidates extends AppCompatActivity {

    String HttpURL = "http://altaitsolutions.com/Altadatabase/pendingcandidates_list.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_not_confirmed_candidates);
        ...
        if(Text.equals("hr"))
        {
            text1.setText("HR Dashboard - Interviews Dashboard - History - Pending Candidates List");
        }
        else  if(Text.equals("admin"))
        {
            text1.setText("Admin Dashboard - Interviews Dashboard - History - Pending Candidates List");
        }
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(not_confirmed_candidates.this,HrDashboard.class);
        ...
        interview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(not_confirmed_candidates.this,Interviews_dashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        history.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(not_confirmed_candidates.this,Interview_history.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        dashboard1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(not_confirmed_candidates.this,AdminDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        /*listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(com.example.anushak.finalaltacrm.not_confirmed_candidates.this, ListViewClickData.getProName(), Toast.LENGTH_SHORT).show();


                Intent intent=new Intent(not_confirmed_candidates.this,Show_single_record.class);
...
*/
    ...
    private class ParseJSonDataClass2 extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            interviewAdapter = new Interview_Adapter(not_confirmed_candidates.this, R.layout.update_list, interviewUpdatesList);
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(not_confirmed_candidates.this, QueryForm.class);
                ...
                Toast.makeText(not_confirmed_candidates.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
