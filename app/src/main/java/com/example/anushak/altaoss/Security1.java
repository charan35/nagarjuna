...
public class Security1 extends AppCompatActivity {
    ...
    Button finger,face;
    TextView id,empid,email,firstname,department;
    String Id,Empid,Email,Firstname,Department;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        face.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Security1.this, FaceLogin.class);
                i.putExtra("Empid",Empid);
                i.putExtra("employee",Id);
