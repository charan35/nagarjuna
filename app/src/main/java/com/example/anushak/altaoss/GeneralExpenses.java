...
public class GeneralExpenses extends AppCompatActivity {
    ...
    String HttpURL = "http://altaitsolutions.com/Altadatabase/generalexpenses.php";
    String HttpURL1 = "http://altaitsolutions.com/Altadatabase/generalapprove.php";
    String HttpURL2 = "http://altaitsolutions.com/Altadatabase/generalreject.php";
    ...
    String Empid,Text,Text1,OFFICIALEMAIL,MANAGERMAIL,MANAGERID,HRMAIL,HRID,EMPID,PDFURL,TYPE,CATEGORY,CLAIMEDAMOUNT,DATE,STATUS;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE,WindowManager.LayoutParams.FLAG_SECURE);
        setContentView(R.layout.activity_general_expenses);
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GeneralExpenses.this,HrDashboard.class);
        ...
        reimbursement.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GeneralExpenses.this,ReimbursementDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        dashboard1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GeneralExpenses.this,AdminDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        if(Text.equals("hr"))
        {
            text1.setText("HR Dashboard - Reimbursement Dashboard - General Expenses");
        }
        else if(Text.equals("admin"))
        {
            text1.setText("Admin Dashboard - Reimbursement Dashboard - General Expenses");
        }
        ...
        listView.setOnMenuItemClickListener(new SwipeMenuListView.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(int position, SwipeMenu menu, int index) {
                ...
                switch (index) {
                    case 0:
                        Toast.makeText(GeneralExpenses.this,"Open", Toast.LENGTH_LONG).show();
                       /* BackGround b = new BackGround();
                        ...
                        break;
                    case 1:
                        Toast.makeText(GeneralExpenses.this,"Close", Toast.LENGTH_LONG).show();
                        break;
                }
                return false;
            }
        ...
        new ParseJSonDataClass(GeneralExpenses.this).execute();
        new ParseJSonDataClass1(GeneralExpenses.this).execute();
        new ParseJSonDataClass2(GeneralExpenses.this).execute();
    }
    ...
    class BackGroundMobile extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("http://altaitsolutions.com/Altadatabase/generalfetch.php");
                String urlParams = "empid=" + empid+ "&General=" + category + "&date=" + date+ "&status=" + status;
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                TYPE = user_data_profile.getString("General");
                CLAIMEDAMOUNT = user_data_profile.getString("ClaimedAmount");
                PDFURL = user_data_profile.getString("PdfURL");

                Intent i = new Intent(GeneralExpenses.this, GeneralUpdate.class);
                i.putExtra("empid",EMPID);
                i.putExtra("category",CATEGORY);
                i.putExtra("date",DATE);
                i.putExtra("status",STATUS);
                i.putExtra("General",TYPE);
                ...
                e.printStackTrace();
                Toast.makeText(GeneralExpenses.this,"Error", Toast.LENGTH_SHORT).show();
            }
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
                    ...
                    if (FinalJSonResult != null) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                String tempFullForm = jsonObject.getString("General").toString();
...

        {
            ...
            reimbursementAdapter = new ReimbursementAdapter(GeneralExpenses.this, R.layout.reimbursement_layout, ReimbursementList);
    ...
    private class ParseJSonDataClass1 extends AsyncTask<Void, Void, Void> {
        ...
        {
            progressBar.setVisibility(View.INVISIBLE);
            reimbursementAdapter1 = new ReimbursementAdapter(GeneralExpenses.this, R.layout.reimbursement_layout, ReimbursementList1);
    ...
    private class ParseJSonDataClass2 extends AsyncTask<Void, Void, Void> {
        ...
        {
            progressBar.setVisibility(View.INVISIBLE);
            reimbursementAdapter2 = new ReimbursementAdapter(GeneralExpenses.this, R.layout.reimbursement_layout, ReimbursementList2);
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(GeneralExpenses.this, QueryForm.class);
                i.putExtra("empid", EMPID);
                ...
                Toast.makeText(GeneralExpenses.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
