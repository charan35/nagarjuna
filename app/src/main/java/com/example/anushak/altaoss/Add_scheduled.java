...
public class Add_scheduled extends AppCompatActivity {

    String HttpURL = "http://altaitsolutions.com/Altadatabase/scheduled_list.php";
    ...
    static String FNAME = null, MNAME = null, PROJECT = null, NAME = null, EMAIL = null, MOBILE = null, SECURITY = null, ANSWER = null,EMPLOYEEID = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Text.equals("hr"))
        {
            text1.setText("HR Dashboard - Interviews Dashboard - Scheduled");
        }
        else  if(Text.equals("admin"))
        {
            text1.setText("Admin Dashboard - Interviews Dashboard - Scheduled");
        }
        ...
        admin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Add_scheduled.this,HrDashboard.class);
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Add_scheduled.this,Interviews_dashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        admin1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Add_scheduled.this,AdminDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Add_scheduled.this, ListViewClickData.getProName(), Toast.LENGTH_SHORT).show();

                Intent intent=new Intent(Add_scheduled.this,Scheduled_single_record.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_add_contact:
               Intent intent=new Intent(Add_scheduled.this,Scheduled_reg.class);
                intent.putExtra("empid",Empid);
                intent.putExtra("employee",Text);
               startActivity(intent);
                return true;
    ...
    private class ParseJSonDataClass2 extends AsyncTask<Void, Void, Void> {
        ...
        {
            interviewAdapter = new Interview_Adapter(Add_scheduled.this, R.layout.update_list, interviewUpdatesList);
  ...
  /*  class BackGroundempdir extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                URL url = new URL("http://altaitsolutions.com/Altadatabase/scheduled_personalinfo.php");
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(Add_scheduled.this,Scheduled_single_record.class);
                ...
                e.printStackTrace();
                Toast.makeText(Add_scheduled.this,"Invalid Details",Toast.LENGTH_LONG).show();
            }
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(Add_scheduled.this, QueryForm.class);
                i.putExtra("empid", EMPID);
