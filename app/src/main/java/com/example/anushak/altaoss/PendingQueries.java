...
public class PendingQueries extends AppCompatActivity {
    ...
    String HttpURL = "http://altaitsolutions.com/Altadatabase/pendingqueries.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queries.setText(" Pending Queries");
        text1.setText("Query Dashboard - Pending Queries ("+Empid+")");
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PendingQueries.this,EmpQuery.class);
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(PendingQueries.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new ParseJSonDataClass(PendingQueries.this).execute();
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
...

        {
            ...
            queryStatusAdapter = new QueryStatusAdapter(PendingQueries.this, R.layout.query_status, QueryList);
            QueryListView.setAdapter(queryStatusAdapter);
            text.setText("Pending Queries- "+ String.valueOf(QueryListView.getCount()));
        }
    }
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(PendingQueries.this, QueryForm.class);
                ...
                Toast.makeText(PendingQueries.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
