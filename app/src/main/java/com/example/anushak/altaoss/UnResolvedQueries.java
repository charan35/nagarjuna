...
public class UnResolvedQueries extends AppCompatActivity {
    ...
    String HttpURL = "http://altaitsolutions.com/Altadatabase/unresolvedqueries.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queries.setText(" UnResolved Queries");
        text1.setText("Query Dashboard - UnResolved Queries ("+Empid+")");
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnResolvedQueries.this,EmpQuery.class);
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(UnResolvedQueries.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new ParseJSonDataClass(UnResolvedQueries.this).execute();
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result)
        {
            ...
            queryStatusAdapter = new QueryStatusAdapter(UnResolvedQueries.this, R.layout.query_status, QueryList);
            QueryListView.setAdapter(queryStatusAdapter);
            text.setText("UnResolved Queries- "+QueryListView.getAdapter().getCount());
        }
    }
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(UnResolvedQueries.this, QueryForm.class);
                ...
                Toast.makeText(UnResolvedQueries.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
