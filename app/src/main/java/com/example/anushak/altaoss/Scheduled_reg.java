...
public class Scheduled_reg extends AppCompatActivity {

    TextView name,interviewtype,status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scheduled_reg);
        ...
        interviewtype = (TextView) findViewById(R.id.scheduled);
        ...
        if(Text.equals("hr"))
        {
            text1.setText("HR Dashboard - Interviews Dashboard - Scheduledlist - New Registration");
        }
        else  if(Text.equals("admin"))
        {
            text1.setText("Admin Dashboard - Interviews Dashboard - Scheduledlist - New Registration");
        }
        ...
        admin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Scheduled_reg.this,HrDashboard.class);
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Scheduled_reg.this,Interviews_dashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        form.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Scheduled_reg.this,Add_scheduled.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        admin1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Scheduled_reg.this,AdminDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Scheduled_reg.BackGround b = new Scheduled_reg.BackGround();
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(Scheduled_reg.this, QueryForm.class);
                ...
                Toast.makeText(Scheduled_reg.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
