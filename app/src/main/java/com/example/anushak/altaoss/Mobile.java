...
public class Mobile extends AppCompatActivity {
    ...
    String HttpURL = "http://altaitsolutions.com/Altadatabase/reimbursementlist.php";
    String HttpURL1 = "http://altaitsolutions.com/Altadatabase/approvelist.php";
    String HttpURL2 = "http://altaitsolutions.com/Altadatabase/rejectlist.php";
    ...
    String Empid,Text,Text1,OFFICIALEMAIL,MANAGERMAIL,MANAGERID,HRMAIL,HRID,EMPID,CATEGORY,STATUS,DATE,MOBILENUMBER,CLAIMEDAMOUNT,PDFURL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Text.equals("hr"))
        {
            text1.setText("HR Dashboard - Reimbursement Dashboard - Mobile");
        }
        else if(Text.equals("admin"))
        {
            text1.setText("Admin Dashboard - Reimbursement Dashboard - Mobile");
        }
        ...
        listView.setOnMenuItemClickListener(new SwipeMenuListView.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(int position, SwipeMenu menu, int index) {
                ...
                switch (index) {
                    case 0:
                       // Toast.makeText(Mobile.this,"Open",Toast.LENGTH_LONG).show();
        ...
        new ParseJSonDataClass(Mobile.this).execute();
        new ParseJSonDataClass1(Mobile.this).execute();
        new ParseJSonDataClass2(Mobile.this).execute();
    }
    ...
    class BackGroundMobile extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("http://altaitsolutions.com/Altadatabase/mobileupdate.php");
                String urlParams = "empid=" + empid+ "&category=" + category + "&date=" + date+ "&status=" + status;
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                MOBILENUMBER = user_data_profile.getString("Mobile");
                CLAIMEDAMOUNT = user_data_profile.getString("ClaimedAmount");
                PDFURL = user_data_profile.getString("PdfURL");

                Intent i = new Intent(Mobile.this, Reimbusrment1.class);
                ...
                e.printStackTrace();
                Toast.makeText(Mobile.this,"Error", Toast.LENGTH_SHORT).show();
            }
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
                    ...
                    if (FinalJSonResult != null) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                String tempFullForm = jsonObject.getString("category").toString();
...

        {
            ...
            reimbursementAdapter = new ReimbursementAdapter(Mobile.this, R.layout.reimbursement_layout, ReimbursementList);
    ...
    private class ParseJSonDataClass1 extends AsyncTask<Void, Void, Void> {
        ...
        {
            progressBar.setVisibility(View.INVISIBLE);
            reimbursementAdapter1 = new ReimbursementAdapter(Mobile.this, R.layout.reimbursement_layout, ReimbursementList1);
    ...
    private class ParseJSonDataClass2 extends AsyncTask<Void, Void, Void> {
        ...
        {
            progressBar.setVisibility(View.INVISIBLE);
            reimbursementAdapter2 = new ReimbursementAdapter(Mobile.this, R.layout.reimbursement_layout, ReimbursementList2);
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Toast.makeText(Mobile.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
