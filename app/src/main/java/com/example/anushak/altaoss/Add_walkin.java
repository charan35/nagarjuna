...
public class Add_walkin extends AppCompatActivity {

    //String HttpURL = "http://altaitsolutions.com/Altadatabase/walkin_List.php";

    String HttpURL = "http://altaitsolutions.com/Altadatabase/walkin_List.php";

    ListView listView;

    static String FNAME = null, MNAME = null, LNAME = null, NAME = null, EMAIL = null, MOBILE = null, PROJECT = null, ANSWER = null, EMPLOYEEID = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_walkin);
        ...
        if (Text.equals("hr")) {
            text1.setText("HR Dashboard - Interviews Dashboard - Walkins");
        } else if (Text.equals("admin")) {
            text1.setText("Admin Dashboard - Interviews Dashboard - Walkins");
        }
        ...
        admin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Add_walkin.this, HrDashboard.class);
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Add_walkin.this, Interviews_dashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        admin1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Add_walkin.this, AdminDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Add_walkin.this, ListViewClickData.getProName(), Toast.LENGTH_SHORT).show();


                Intent intent=new Intent(Add_walkin.this,Show_single_record.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_add_contact:
                Intent intent = new Intent(Add_walkin.this, Walkin_reg.class);
                intent.putExtra("empid", Empid);
                intent.putExtra("employee", Text);
                startActivity(intent);
                return true;
    ...
    private class ParseJSonDataClass2 extends AsyncTask<Void, Void, Void> {
        ...
        {
            interviewAdapter = new Interview_Adapter(Add_walkin.this, R.layout.interview_update_list, interviewUpdatesList);
    ...
    class BackGroundempdir extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(Add_walkin.this,Show_single_record.class);
                ...
                e.printStackTrace();
                Toast.makeText(Add_walkin.this,"Invalid Details",Toast.LENGTH_LONG).show();
            }
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(Add_walkin.this, QueryForm.class);
                i.putExtra("empid", EMPID);
