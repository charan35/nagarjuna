...
public class UnableQueries extends AppCompatActivity {
    ...
    String HttpURL = "http://altaitsolutions.com/Altadatabase/unablequeries.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queries.setText(" Unable_to_Resolve Queries");
        text1.setText("Query Dashboard - Unable to Resolve Queries ("+Empid+")");
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(UnableQueries.this,EmpQuery.class);
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(UnableQueries.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new ParseJSonDataClass(UnableQueries.this).execute();
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result)
        {
            ...
            queryStatusAdapter = new QueryStatusAdapter(UnableQueries.this, R.layout.query_status, QueryList);
            QueryListView.setAdapter(queryStatusAdapter);
            text.setText("Unable to Resolve Queries- "+QueryListView.getAdapter().getCount());
        }
    }
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(UnableQueries.this, QueryForm.class);
                ...
                Toast.makeText(UnableQueries.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
