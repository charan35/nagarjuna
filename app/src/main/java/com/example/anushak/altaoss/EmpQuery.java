...
public class EmpQuery extends AppCompatActivity {

    TextView empid,dashboard,text,text1;
    String Empid,Text1,OFFICIALEMAIL,MANAGERMAIL,MANAGERID,HRMAIL,HRID,EMPID;
    ...
    String HttpURL = "http://altaitsolutions.com/Altadatabase/empquerylist.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emp_query);
        ...
        empid.setText(Empid);
        text1.setText("Employee Dashboard - Emp Total Queries("+Empid+")");
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EmpQuery.this,EmployeeDashboard.class);
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(EmpQuery.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new ParseJSonDataClass(EmpQuery.this).execute();
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
...

        {
            ...
            queryStatusAdapter = new QueryStatusAdapter(EmpQuery.this, R.layout.query_status, QueryList);
            QueryListView.setAdapter(queryStatusAdapter);
            text.setText("Total Queries- "+ String.valueOf(QueryListView.getCount()));
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.pending)
        {
            Intent intent = new Intent(EmpQuery.this,PendingQueries.class);
            intent.putExtra("empid",Empid);
            startActivity(intent);
        }
        if(id == R.id.resolved)
        {
            Intent intent = new Intent(EmpQuery.this,ResolvedQueries.class);
            intent.putExtra("empid",Empid);
            startActivity(intent);
        }
        if(id == R.id.unresolved)
        {
            Intent intent = new Intent(EmpQuery.this,UnResolvedQueries.class);
            intent.putExtra("empid",Empid);
            startActivity(intent);
        }
        if(id == R.id.unable)
        {
            Intent intent = new Intent(EmpQuery.this,UnableQueries.class);
            intent.putExtra("empid",Empid);
            startActivity(intent);
        }
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(EmpQuery.this, QueryForm.class);
                ...
                Toast.makeText(EmpQuery.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
