...
public class GeneralUpdate extends AppCompatActivity {
    ...
    TextView empid,category,date,status,general,amount;
    String Empid,Category,Date,Status,General,Amount,PdfUrl,Text,Text1,OFFICIALEMAIL,MANAGERMAIL,MANAGERID,HRMAIL,HRID,EMPID;
    ImageView pdfurl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        general=(TextView) findViewById(R.id.mobilenumber);
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GeneralUpdate.this,HrDashboard.class);
        ...
        reimbursement.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GeneralUpdate.this,ReimbursementDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GeneralUpdate.this,GeneralExpenses.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        dashboard1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GeneralUpdate.this,AdminDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        if(Text.equals("hr"))
        {
            text1.setText("HR Dashboard - Reimbursement Dashboard - General Expenses List - Permission");
        }
        else if(Text.equals("admin"))
        {
            text1.setText("Admin Dashboard - Reimbursement Dashboard - General Expenses List - Permission");
        }
        ...
        approve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                General = general.getText().toString();
                Amount = amount.getText().toString();

                new Update(GeneralUpdate.this,0).execute(Empid, Category, Date, Status, General,Amount);
            }
        });
    ...
    class Update extends AsyncTask<String, Void, String>
    {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                String general = (String) arg0[4];
                String amount = (String) arg0[5];

                String link = "http://altaitsolutions.com/Altadatabase/generalupdate.php";
                ...
                data += "&" + URLEncoder.encode("General", "UTF-8") + "=" + URLEncoder.encode(general, "UTF-8");
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(GeneralUpdate.this, QueryForm.class);
                ...
                Toast.makeText(GeneralUpdate.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
