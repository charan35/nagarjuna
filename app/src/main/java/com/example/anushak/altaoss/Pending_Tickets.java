...
public class Pending_Tickets extends AppCompatActivity {
    ...
    String HttpURL = "http://192.168.1.54/Ticketing_Tool/pending_tickets.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pending__tickets);
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(Pending_Tickets.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new ParseJSonDataClass(Pending_Tickets.this).execute();
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
...

        {
            ...
            total_tickets_adapter = new Total_Tickets_Adapter(Pending_Tickets.this, R.layout.ticket_layout, TicketsList);
