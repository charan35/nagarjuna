...
public class EmpPayrollDoc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emp_payroll_doc);
        ...
        Year.setText(year);
        text2.setText(Text2);
        text.setText("Admin - EmpPayroll - PayrollDocuments - Document("+month +"/"+ year+")");
        payname.setText("Payslip("+month+"-"+ year+")");

        //Url.setImageURI(Uri.parse(url));
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(EmpPayrollDoc.this,"Downloaded successfully...", Toast.LENGTH_LONG).show();
        ...
        admin.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmpPayrollDoc.this,AdminDashboard.class);
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmpPayrollDoc.this,EmpPayroll.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        pays.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmpPayrollDoc.this,PayrollDocuments.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(EmpPayrollDoc.this, QueryForm.class);
                ...
                Toast.makeText(EmpPayrollDoc.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
