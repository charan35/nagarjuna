...
public class EmpVisitorsList extends AppCompatActivity {

    LinearLayout lq,lq1,lq2;
    ImageView iv25,iv251,iv252;
    TextView dashboard,dashboard1,dashboard2,downloads2;
    ...
    String HttpURL = "http://altaitsolutions.com/Altadatabase/empvisitorslist.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emp_visitors_list);

        VisitorsListView = (ListView)findViewById(R.id.listView);
        ...
        downloads2 = (TextView)findViewById(R.id.downloads2);
        ...
        dashboard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EmpVisitorsList.this,EmployeeDashboard.class);
        ...
        dashboard2.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmpVisitorsList.this,AdminDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        downloads2.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmpVisitorsList.this,Admin_Visitor_dashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        dashboard1.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EmpVisitorsList.this,HrDashboard.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
            }
        });
        ...
        {
            text1.setText("Employee Dashboard - Visitors List("+Empid+")");
        }
        else if(Text.equals("hr"))
        {
            text1.setText("HR Dashboard -  Visitors List("+Empid+")");
        }
        else if(Text.equals("admin"))
        {
            text1.setText("Admin Dashboard - visitor Dashbaord -  Visitors List("+Empid+")");
        }
    ...
    public void HttpWebCall(final String PreviousListViewClickedItem){
        ...
        class HttpWebCallFunction extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = ProgressDialog.show(EmpVisitorsList.this,"Loading Data",null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                new ParseJSonDataClass(EmpVisitorsList.this).execute();
    ...
    private class ParseJSonDataClass extends AsyncTask<Void, Void, Void> {
                ...
                if(FinalJSonObject != null)
                {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            String tempFullForm1 = jsonObject.getString("phone").toString();
...

        {
            ...
            viewvisitorAdapter = new ViewvisitorAdapter(EmpVisitorsList.this, R.layout.visitorlayout, VisitorsList);
            VisitorsListView.setAdapter(viewvisitorAdapter);
            Toast.makeText(context, "Total Number of Visitors are:" + VisitorsListView.getAdapter().getCount(), Toast.LENGTH_SHORT).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.new_visitor,menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.visitor)
        {
           Intent intent =  new Intent(EmpVisitorsList.this,Addvisitor.class);
    ...
    class BackGroundQuery extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                Intent i = new Intent(EmpVisitorsList.this, QueryForm.class);
                ...
                Toast.makeText(EmpVisitorsList.this,"Invalid Details", Toast.LENGTH_LONG).show();
            }
        }
    }
}
